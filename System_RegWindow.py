...
class RegisterWindow:
    def __init__(self, master=None):
        ...
        self.frame_regWindow.configure(
            background='#b92e34', height='350', relief='raised', width='485')
        self.frame_regWindow.pack(expand='false', side='top')

        # ---------------------LABELS----------------------------------------
        # FRAME LABEL
        self.label_createAcc = tk.Label(self.frame_regWindow)
        self.label_createAcc.configure(
            background='#982121', cursor='arrow', font='{Arial} 30 {bold}', foreground='#f9d71c')
        self.label_createAcc.configure(
            relief='flat', text='     CREATE ACCOUNT       ')
        self.label_createAcc.place(anchor='nw', x='0', y='0')

        # LAST NAME LABEL
        self.label_lName = tk.Label(self.frame_regWindow)
        self.label_lName.configure(
            background='#b92e34', font='{Consolas} 15 {bold}', foreground='#f9d71c', text='LAST NAME:*')
        self.label_lName.place(anchor='nw', x='10', y='60')

        # FIRST NAME LABEL
        self.label_fName = tk.Label(self.frame_regWindow)
        self.label_fName.configure(
            background='#b92e34', font='{Consolas} 15 {bold}', foreground='#f9d71c', text='FIRST NAME:*')
        self.label_fName.place(anchor='nw', x='10', y='90')

        # ADDRESS LABEL
        self.label_address = tk.Label(self.frame_regWindow)
        self.label_address.configure(
            background='#b92e34', font='{cONSOLAS} 15 {bold}', foreground='#f9d71c', text='CITY:')
        self.label_address.place(anchor='nw', x='10', y='120')

        # CONTACT NUMBER LABEL
        self.label_cNumber = tk.Label(self.frame_regWindow)
        self.label_cNumber.configure(
            background='#b92e34', font='{consolas} 15 {bold}', foreground='#f9d71c', text='CONTACT NUMBER:')
        self.label_cNumber.place(anchor='nw', x='10', y='150')

        # USERNAME LABEL
        self.label_uName = tk.Label(self.frame_regWindow)
        self.label_uName.configure(
            background='#b92e34', font='{consolas} 15 {bold}', foreground='#f9d71c', text='USERNAME:*')
        ...
        self.label_password.configure(
            background='#b92e34', font='{CONSOLAS} 15 {bold}', foreground='#f9d71c', text='PASSWORD:*')
        self.label_password.place(anchor='nw', x='10', y='210')

        # CONFIRM PASSWORD LABEL
        self.label_conPassword = tk.Label(self.frame_regWindow)
        self.label_conPassword.configure(
            background='#b92e34', font='{CONSOLAS} 15 {bold}', foreground='#f9d71c', text='CONFIRM PASSWORD:*')
        ...
        self.entry_conPassword.place(
            anchor='nw', width='250', x='220', y='240')

        # ---------------------BUTTONS----------------------------------------
        # REGISTER BUTTON
        self.button_register = tk.Button(self.frame_regWindow)
        self.button_register.configure(
            background='#77dd77', font='{arial} 10 {bold}', relief='ridge', text='REGISTER')
        ...
        self.button_regCancel.configure(
            background='#ff6961', font='{arial} 10 {bold}', relief='ridge', text='CANCEL')
    ...
    def register_action(self):
        ...
        string_for_insert = f'INSERT INTO ekasborgers.useraccounts_t(user_name,user_password,user_type,f_name,l_name,city,contact_number) VALUES \
    ...
    def empty_field(self):
        ...
        try:
            ...
            messagebox.showerror(
                "Invalid Input", "An account with an existing username already exists! Please try again!")
            return True
        except Exception as e:
            messagebox.showerror(
                "Invalid Input", "Username must have at least 5 characters")
            return True
        ...
        try:
            ...
            messagebox.showerror(
                "Invalid Input", "Password must have at least 5 characters")
            return True
        ...
        try:
            ...
            messagebox.showerror(
                "Invalid Input", "Confirm password field is empty!")
            return True
        except Exception as e:
            messagebox.showerror(
                "Invalid Input", "Password does not match confirm password field!")
            return True
